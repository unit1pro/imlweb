    ...
    <div class="col-xs-12 col-md-6 mt50">
        ...
        <div class="addPost">
            <div class="col-xs-2 col-sm-1 nopadding-left">
                ...
                <div class="user-pic"><img src="<?php echo $userImageHeader; ?>"/></div>
            </div>
    ...
    <div class="col-xs-12 col-md-3 mt50">
        <div class="rightPanel">
            <div class="singerPic">
                ...
                <div class="singerName"><a href="<?php echo site_url(); ?>">Shikhar Kumar</a></div>
            </div>
            ...
            <div class="drop_area" style="padding: 15px 7px 10px;background: #066686;">
                <form class="" action="" method="post" id="comment_post_form">
                    <div class="form-group">
                        <textarea class="form-control" name="COMMENTS" placeholder="Your work" id="post_textarea"></textarea>
                    </div>
                </form>
